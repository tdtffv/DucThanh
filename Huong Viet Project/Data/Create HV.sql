...
ALTER TABLE GIO ADD CONSTRAINT FK_G_MA FOREIGN KEY (MAMON) REFERENCES MONAN(MAMON)
ALTER TABLE GIO ADD CONSTRAINT FK_G_CN FOREIGN KEY (MACN) REFERENCES CHINHANH(MACN)
GO
--Khóa khác
